  ...
  <div class="tiny-container">
    ...
    <div class="uba-content">
      <el-tabs v-model="activeName">
        <el-tab-pane :label="this.$t('depositsToBuy.platform')"
          name="first">
          <platform v-if="activeName === 'first'"
            ref="platformChild"
            :date="datePop"></platform>
        </el-tab-pane>
        <el-tab-pane :label="this.$t('depositsToBuy.channel')"
          name="second">
        ...
        <el-tab-pane :label="this.$t('depositsToBuy.location')"
          name="third">
        ...
        <el-tab-pane :label="this.$t('depositsToBuy.bank')"
          name="fourth">
        ...
        <el-tab-pane :label="this.$t('depositsToBuy.user')"
          name="fifth">
        ...
        <el-tab-pane :label="this.$t('depositsToBuy.gather')"
          name="sixth">
